# Laravel base
The original [repo](https://github.com/aschmelyun/docker-compose-laravel) is maintained by [@Aschmelyun](https://github.com/aschmelyun)
...
2. Follow steps in [src/README.md](src/README.md)
